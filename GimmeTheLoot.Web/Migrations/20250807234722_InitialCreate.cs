        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPlaidAccountId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaidAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlaidAccounts_UserPlaidAccounts_UserPlaidAccountId",
                        column: x => x.UserPlaidAccountId,
                        principalTable: "UserPlaidAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaidAccounts_UserPlaidAccountId",
                table: "PlaidAccounts",
                column: "UserPlaidAccountId");
        }
